...
- **Stack Trace Hook**: Before reading large log files, you MUST run `run_shell_command("python {{HARNESS_DIR}}/scripts/extract_stacktrace.py <file>")` to minimize context usage.
